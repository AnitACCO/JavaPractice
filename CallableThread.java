...
class FileWriter2 implements Callable<String> {
...
public class CallableThread {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        FileWriter2 fw2 = new FileWriter2("name2c.txt","Anit2");
        Future<String> x2 = executorService.submit(fw2);
        if(x.get().equals("Done") && x2.get().equals("Done")) {
        ...
        Future<String> x = executorService.submit(a,str);
    }
}
